...
def create_apple_run_paths(
    ...
    stem = (
        f"apple_fedavg_backbone_taskhead"
        f"{subset_id}"
        f"_rounds{rounds}"
...
def build_apple_log_row(
    *,
    ...
    return {
        "run_type": "apple_fedavg_backbone_taskhead",
        "algorithm": "apple_fedavg_backbone_taskhead",
        "subset_id": subset_id,
    ...
    *,
    ...
    for round_idx in range(1, rounds + 1):
        ...
        for eval_mask_mode in ("full", "visible"):
            ...
            if current_value < best_by_eval_mode[eval_mask_mode]["value"]:
                ...
                best_by_eval_mode[eval_mask_mode]["backbone_dr_matrix"] = (
    ...
    state_by_eval_mode = {
        mode: {
            ...
            "backbone_dr_matrix": best_by_eval_mode[mode]["backbone_dr_matrix"].clone(),
        }
    ...
    print("\n" + "=" * 100)
    print("APPLE FEDAVG-BACKBONE TASK-HEAD DUAL-EVALUATION SMOKE CHECK")
    print("=" * 100)
