...
def build_apple_log_row(
    *,
    ...
    return {
        "run_type": "apple_fedavg_backbone_oracleq_taskhead",
        "algorithm": "apple_fedavg_backbone_oracleq_taskhead",
        "subset_id": subset_id,
...
def run_apple_experiment(
    ...
    *,
    ...
    checkpoint = {
        ...
        "oracle_task_matrix": (
            default_dr_matrix[0].clone()
            if default_dr_matrix.ndim == 3
            else default_dr_matrix.clone()
        ),
