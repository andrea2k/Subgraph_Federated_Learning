...
RUNS_ROOT = os.environ.get("RUNS_ROOT", "andrea/runs_multiselect_apple_post_ala")
...
RESULT_RUN_TYPE = "apple_post_ala_multi_select"
RESULT_ALGORITHM = "apple_post_ala_multi_select"
DISPLAY_NAME = "APPLE-PostALA FedAvg-Backbone+TaskHead (multi-selection)"
...
def main() -> None:
    ...
    print(
        "RUN VARIANT: APPLE-PostALA FedAvgBackboneTaskHead (multi-selection) | selection_metrics="
    ...
    base_cfg["selection_tag"] = "ms5_apple_post_ala"
    ...
    for cfg, meta in sweep:
        ...
        for _, row in chosen_df.iterrows():
            ...
            print()
            print(
                f"Starting with {len(subset_clients)}-client APPLE-PostALA FedAvgBackboneTaskHead training",
                row["subset_clients"],
            )
            print(meta)
            ...
            progress.step(
                label=f"APPLE-PostALA FedAvgBackboneTaskHead done -> {run_paths.csv_path}",
