...
from andrea.helper_funcs_multihead.gcflplus_run_helper import (
    build_gcfl_log_row,
    run_gcfl,
)
...
EXPERIMENT_LOG_FOLDER = "gcflplus_multihead_clustering_experiment"
...
def main():
    ...
    for cfg, meta in sweep:
        ...
        for _, row in chosen_df.iterrows():
            ...
            print("\nGCFL+ MULTI-HEAD SANITY")
            print("subset:", row["subset_clients"])
            print("num clients:", len(subset_clients))
            print("output_head:", cfg.get("output_head"))
            print("architecture:", cfg.get("architecture"))
            print("warmup:", WARMUP_ROUNDS)
            print("grad_seq_len:", GRAD_SEQ_LEN)
            print("min_cluster_size:", MIN_CLUSTER_SIZE)
            print("min_child_size:", MIN_CHILD_SIZE)
