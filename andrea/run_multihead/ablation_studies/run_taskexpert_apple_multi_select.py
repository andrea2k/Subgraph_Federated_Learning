...
BASE_EXPERIMENT_LOG_FOLDER = "taskexpert_apple_fedavg_backbone_taskhead_clustering_experiment_multi_select"
...
RUNS_ROOT = os.environ.get("RUNS_ROOT", "andrea/runs_multiselect_taskexpert_apple")
...
RESULT_RUN_TYPE = "taskexpert_apple_multi_select"
RESULT_ALGORITHM = "taskexpert_apple_multi_select"
DISPLAY_NAME = "TaskExpert-APPLE FedAvg-Backbone+TaskHead (multi-selection)"
...
def main() -> None:
    ...
    print("RUN VARIANT: TaskExpert-APPLE FedAvgBackboneTaskHead (multi-selection) | selection_metrics=" + "|".join(SELECTION_METRICS))
    ...
    base_cfg["selection_tag"] = "ms5_taskexpert"
