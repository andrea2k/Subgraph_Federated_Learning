...
from andrea.helper_funcs_multihead.apple_fedavg_backbone_qinit_task_head_run_helper import (
    build_apple_log_row,
    run_apple,
)
...
EXPERIMENT_LOG_FOLDER = "apple_fedavg_backbone_qinit_taskhead_clustering_experiment"
...
def main():
    ...
    print("\nFEDAVG-BACKBONE + Q-INIT LEARNED TASK-HEAD CONFIG")
    ...
    for cfg, meta in sweep:
        ...
        for _, row in chosen_df.iterrows():
            ...
            print()
            print(
                f"Starting with {len(subset_clients)}-client fedavg-backbone + qinit task-head training",
                row["subset_clients"],
            )
            print(meta)
            print(
