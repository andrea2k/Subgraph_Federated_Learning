...
EXPERIMENT_LOG_FOLDER = "fully_local_multihead_clustering_experiment"
        ...
        for _, row in chosen_df.iterrows():
            ...
            for graph_id in subset_id:
                ...
                relabel_result_csv(
                    ...
                    run_type="fully_local",
                    algorithm="fully_local",
                    extra={
                ...
                local_log_row["run_type"] = "fully_local"
                local_log_row["algorithm"] = "fully_local"
