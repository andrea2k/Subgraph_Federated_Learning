...
def components_original_split(
    ...
    """
    print(
        f"Conducting subgraph-FL Component (original, {client_assignment}-assigned) simulation..."
    )
    ...
    motifs_filter = motifs_only_filter(
        global_data.num_nodes, global_data.edge_index, motifs_src, motifs_dst
    )
